...
const Footer: React.FC = () => {
  return (
    <div className="mt-16 flex w-full justify-center lg:mt-0 lg:px-5 lg:py-20">
      <div className="flex w-full max-w-[1280px] flex-col justify-between gap-4 bg-[#544790] bg-opacity-35 px-8 pt-12 lg:flex-row lg:rounded-[48px] lg:px-[70px] lg:py-8">
        <div className="flex h-full w-full flex-col text-center md:min-w-[512px] lg:gap-0 lg:text-left">
          <div className="flex w-full flex-col mb-12 items-center justify-between gap-6 md:flex-row lg:gap-0">
        ...
        <div className="flex flex-col items-center gap-8 p-4 md:min-w-[336px] lg:items-start">
          ...
          <div className="flex gap-4">
            <div className="flex flex-col gap-2 text-xs">
              <Link href="/instagram-highlight-viewer">
                Instagram Highlight Viewer
              </Link>
              <Link href="/instagram-story-download">
                Instagram Story Download
              </Link>
              <Link href="/instagram-reels-video-downloader">
